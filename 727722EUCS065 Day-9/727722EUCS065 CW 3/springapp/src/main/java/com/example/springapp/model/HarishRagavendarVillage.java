...
@Entity
public class HarishRagavendarVillage {
    @Id
    ...
    public HarishRagavendarVillage(){}
    public HarishRagavendarVillage(int villageId, String villageName, int numOfMen, int numOfWomen, int villagePopulation,
            int numOfSchools) {
