...
@Entity
public class HarishRagavendarChildren {
    @Id
    private int babyId;
    ...
    public HarishRagavendarChildren() {
    }
    public HarishRagavendarChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
            String address) {
        this.babyId = babyId;
